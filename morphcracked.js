! function(t, e) {
	...
	function stringToRawPath(t) {
		...
		for (e = 0; e < w; e++)
			if (u = a, isNaN(P[e]) ? i = (a = P[e].toUpperCase()) !== P[e] : e--, r = +P[e + 1], o = +P[e + 2], i && (r += _, o += v), e || (h = r, l = o), "M" === a) s && (s.length < 8 ? --m.length : y += s.length), _ = h = r, v = l = o, s = [r, o], m.push(s), e += 2, a = "L";
			else if ("C" === a) i || (_ = v = 0), (s = s || [0, 0]).push(r, o, _ + 1 * P[e + 3], v + 1 * P[e + 4], _ += 1 * P[e + 5], v += 1 * P[e + 6]), e += 6;
		else if ("S" === a) c = _, g = v, "C" !== u && "S" !== u || (c += _ - s[s.length - 4], g += v - s[s.length - 3]), i || (_ = v = 0), s.push(c, g, r, o, _ += 1 * P[e + 3], v += 1 * P[e + 4]), e += 4;
		...
		else if ("L" === a || "Z" === a) "Z" === a && (r = h, o = l, s.closed = !0), ("L" === a || .5 < D(_ - r) || .5 < D(v - o)) && (zc(_, v, r, o), "L" === a && (e += 2)), _ = r, v = o;
		else if ("A" === a) {
			if (p = P[e + 4], d = P[e + 5], c = P[e + 6], g = P[e + 7], n = 7, 1 < p.length && (p.length < 3 ? (g = c, c = d, n--) : (g = d, c = p.substr(2), n -= 2), d = p.charAt(1), p = p.charAt(0)), f = arcToSegment(_, v, +P[e + 1], +P[e + 2], +P[e + 3], +p, +d, (i ? _ : 0) + 1 * c, (i ? v : 0) + 1 * g), e += n, f)
	...
	function V(t, e) {
		...
		for (var n, r, o, a, i, s, h, l, c, g, f, u, p, d, P, m, _ = t.length, v = t[0][0], w = v, y = t[0][1], x = y, M = 1 / e; - 1 < --_;)
			for (n = (i = t[_]).length, a = 6; a < n; a += 6)
				for (c = i[a], g = i[a + 1], f = i[a + 2] - c, d = i[a + 3] - g, u = i[a + 4] - c, P = i[a + 5] - g, p = i[a + 6] - c, m = i[a + 7] - g, s = e; - 1 < --s;) v < (r = ((h = M * s) * h * p + 3 * (l = 1 - h) * (h * u + l * f)) * h + c) ? v = r : r < w && (w = r), y < (o = (h * h * m + 3 * l * (h * P + l * d)) * h + g) ? y = o : o < x && (x = o);
	...
	function $(t, e, n) {
		...
		if (n)
			for (reverseSegment(r = t.slice(0)), a = 6; a < i; a += 6)(o = Z(r, e, a / 6, l, c)) < g && (g = o, f = -a);
		return f / 6
	}

	function _(t, e, n) {
		for (var r, o, a, i, s, h, l = t.length, c = 1e20, g = 0, f = 0; - 1 < --l;)
			for (h = (r = t[l]).length, s = 0; s < h; s += 6) o = r[s] - e, a = r[s + 1] - n, (i = v(o * o + a * a)) < c && (c = i, g = r[s], f = r[s + 1]);
		return [g, f]
	}
	...
	function ba(t, e) {
		var n, r, o, a, i, s, h, l, c, g, f, u, p, d, P = 0,
			m = t.length,
			_ = e / ((m - 2) / 6);
		for (p = 2; p < m; p += 6)
			for (P += _; .999999 < P;) n = t[p - 2], r = t[p - 1], o = t[p], a = t[p + 1], i = t[p + 2], s = t[p + 3], h = t[p + 4], l = t[p + 5], c = n + (o - n) * (d = 1 / ((Math.floor(P) || 1) + 1)), c += ((f = o + (i - o) * d) - c) * d, f += (i + (h - i) * d - f) * d, g = r + (a - r) * d, g += ((u = a + (s - a) * d) - g) * d, u += (s + (l - s) * d - u) * d, t.splice(p, 4, n + (o - n) * d, r + (a - r) * d, c, g, c + (f - c) * d, g + (u - g) * d, f, u, i + (h - i) * d, s + (l - s) * d), p += 6, m += 6, P--;
		return t
	}

	function ca(t, e, n, r, o) {
		var a, i, s, h, l, c, g, f = e.length - t.length,
			u = 0 < f ? e : t,
			p = 0 < f ? t : e,
			d = 0,
			P = "complexity" === r ? W : X,
			...
			x = "log" === n;
		if (p[0]) {
			if (1 < u.length && (t.sort(P), e.sort(P), u.size || V(u), p.size || V(p), c = u.centerX - p.centerX, g = u.centerY - p.centerY, P === X))
				for (v = 0; v < p.length; v++) u.splice(v, 0, aa(p[v], u, v, m, c, g));
			if (f)
				for (f < 0 && (f = -f), u[0].length > p[0].length && ba(p[0], (u[0].length - p[0].length) / 6 | 0), v = p.length; d < f;) u[v].size || U(u[v]), h = (s = _(p, u[v].centerX, u[v].centerY))[0], l = s[1], p[v++] = [h, l, h, l, h, l, h, l], p.totalPoints += 8, d++;
	...
	function fa(t, e) {
		...
		for (n = .5 * e / (.5 * (o = t.length) - 1), r = 0; r < o - 2; r += 2) {
			if (l += n, s = parseFloat(t[r + 2]), h = parseFloat(t[r + 3]), .999999 < l)
				for (i = 1 / (Math.floor(l) + 1), a = 1; .999999 < l;) f += (c + (s - c) * i * a).toFixed(2) + "," + (g + (h - g) * i * a).toFixed(2) + " ", l--, a++;
			f += s + "," + h + " ", c = s, g = h
		}
		return f
	}
				...
				if (c = e.shapeIndex || 0 === e.shapeIndex ? e.shapeIndex : "auto", g = e.map || K.defaultMap, this._prop = e.prop, this._render = e.render || K.defaultRender, this._apply = "updateTarget" in e ? e.updateTarget : K.defaultUpdateTarget, this._rnd = Math.pow(10, isNaN(e.precision) ? 2 : +e.precision), this._tween = n, h) {
					if (this._target = t, y = "object" == typeof e.precompile, p = this._prop ? t[this._prop] : t.getAttribute(i), this._prop || t.getAttributeNS(null, "data-original") || t.setAttributeNS(null, "data-original", p), "d" === i || this._prop) {
						...
						for ("log" !== e.precompile && !0 !== e.precompile || M('precompile:["' + rawPathToString(p) + '","' + rawPathToString(d) + '"]'), (S = "linear" !== (e.type || K.defaultType)) && (p = ja(p, e.smoothTolerance), d = ja(d, e.smoothTolerance), p.size || V(p), d.size || V(d), b = ka(j[0]), this._origin = p.origin = {
							...
							}), this._rawPath = t._gsRawPath = p, m = p.length; - 1 < --m;)
							for (v = p[m], w = d[m], f = v.isSmooth || [], u = w.isSmooth || [], _ = v.length, P = I = 0; P < _; P += 2) w[P] === v[P] && w[P + 1] === v[P + 1] || (S ? f[P] && u[P] ? (x = v.smoothData, T = w.smoothData, N = P + (P === _ - 4 ? 7 - _ : 5), this._controlPT = {
				...
				if (1 === t && e._apply)
					...
					if (_._gsRawPath = p, e._apply) {
						for (n = "", h = 0; h < p.length; h++)
							for (a = (o = p[h]).length, n += "M" + (o[0] * m | 0) / m + " " + (o[1] * m | 0) / m + " C", s = 2; s < a; s++) n += (o[s] * m | 0) / m + " ";
